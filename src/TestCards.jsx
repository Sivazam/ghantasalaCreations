    ...
    return(
        <div className="container-fluid  mainContainer ">
            <div className="row lm90">
                {qna.map((x,i) => {
                    return (<>
                     <div className="col-xl-5 col-md-12  col-sm-12 col-xs-12 card-main" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={handleSelect} >
                        ...
                        <div className="modal-dialog modal-dialog-centered" >
                            <div className="modal-content" style={{background: "grey"}} >
